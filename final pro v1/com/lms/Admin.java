...
public class Admin extends JFrame{
  ...
  // }
    ...
    public Admin(String title) {
        super(title);
        this.setContentPane(Adminpanel1);
        ...
        try{
            ResultSet rs1 = null;
            String sql = "select * from admin where Ad_id= " + AdminM.Ad_id;
        ...
        btngdetailsT.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    pst = con.prepareStatement("SELECT fname,lname,dob,pno,email,sex,password from tecofficer where tec_id = ?");
                    pst.setString(1, tec_id);
                    ResultSet rs = pst.executeQuery();
        ...
        btndelT.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    pst = con.prepareStatement("DELETE FROM tecofficer WHERE tec_id = ?");
                    pst.setString(1, tec_id);
                    pst.executeUpdate();
                    JOptionPane.showMessageDialog(null, "Record Deleted");
                    table3_load();
        ...
        btnupdT.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    pst = con.prepareStatement("UPDATE tecofficer SET fname = ?,lname = ?,sex = ?,pno = ?,email = ?,password = ?,dob = ? where tec_id = ?");
...
//DELETE ROW DATA FROM L4S1 ICT TME TABLE
    ...
    public void connect() {
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/lms-java1", "root", "jamzee");
    ...
    public void table3_load() {
        try {
            pst = con.prepareStatement("SELECT * FROM tecofficer");
            ResultSet rs = pst.executeQuery();
